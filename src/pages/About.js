  ...
  return (
    <div className="bg-black text-white py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 relative z-10">
        ...
        <div className="mb-20">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 ">ABOUT IEEE COMPUTER SOCIETY</h2>
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 ">ABOUT IEEE COMPUTER SOCIETY KITS</h2>
          <p className="text-base sm:text-lg text-gray-400 mb-4">
