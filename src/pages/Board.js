...
const facultyAdvisors = [
  { name: 'Dr. J. Immanuel Johnraja', role: 'HOD CSE', image: '/Immanuel Johnraja - Head Of Division (CSE).png', description: 'As the Head of the Computer Science Engineering Department, Dr. J. Immanuel Johnraja provides strategic oversight and academic leadership to the department, fostering an environment of innovation and excellence.' },
  ...
  return (
    <div className="bg-black text-white py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 relative z-10">
        <h1 className="text-4xl sm:text-5xl font-bold text-center mb-12">Meet Our Leaders</h1>

        <h2 className="text-2xl sm:text-3xl font-bold text-center my-8">Faculty Advisor</h2>
        <div className="flex flex-wrap justify-center gap-8">
          {facultyAdvisors.map((member, index) => (
            <div key={index} className="w-full sm:w-96 cursor-pointer" onClick={() => openModal(member)}>
              <div className="group bg-gray-800 bg-opacity-50 p-8 rounded-lg text-center h-full transition-transform duration-300 transform hover:scale-105 shadow-lg">
                ...
                <p className="text-base sm:text-lg text-gray-400">{member.role}</p>
              </div>
            </div>
          ))}
        </div>

        <h2 className="text-2xl sm:text-3xl font-bold text-center my-8">Executive Committee</h2>
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-center my-8">Domain-Focused Leadership</h2>
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-center my-8">Team Leads</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
