...
const socialLinks = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/company/ieee-cs-kits/', icon: '💼' },
  { name: 'Instagram', url: 'https://www.instagram.com/ieee_cs_kits/', icon: '📸' },
  { name: 'YouTube', url: 'https://www.youtube.com/channel/UC_u-sM_3PzI_8_v4g-X9g_w', icon: '📺' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-8">
            {/* Faculty Counselor */}
            <div className="group bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-lg">
              <h2 className="text-3xl font-bold mb-4">Faculty Counselor</h2>
              <h3 className="text-2xl font-bold">{facultyCounselor.name}</h3>
              <p className="text-lg text-gray-400">{facultyCounselor.role}</p>
              <div className="mt-4">
            ...
            <div className="group bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-lg">
              <h2 className="text-3xl font-bold mb-4">Student Coordinators</h2>
              {studentCoordinators.map((coordinator, index) => (
                <div key={index} className="mb-4">
                  <h3 className="text-2xl font-bold">{coordinator.name}</h3>
                  <p className="text-lg text-gray-400">{coordinator.role}</p>
                  <div className="mt-2">
                    <p className="text-lg text-gray-400">
          ...
          <div className="space-y-8">
            {/* Contact Form */}
            <div className="group bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-lg h-fit">
            ...
            <div className="group bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-lg">
              ...
              <div className="flex justify-center space-x-8">
                {socialLinks.map((link, index) => (
                  <a key={index} href={link.url} target="_blank" rel="noopener noreferrer" className="text-lg text-gray-400 hover:text-white">
